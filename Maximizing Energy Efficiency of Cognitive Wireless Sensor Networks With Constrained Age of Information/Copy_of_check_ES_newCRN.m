...
if 0 %verify summation of   
    ...
    fprintf('E[ssv^2]: %1.3f  = %1.3f   \n', mean(ssv.^2),((2/(p^2))*(u)^2)+(((2/(p^2))+2)*(v)^2)+(1/p)*(1/p+1)*(u*v*2));
    ...
    fprintf('var[ssv]: %1.3f  = %1.3f   \n',var(ssv),(2*(u^2+v^2+u*v)*((1/p)-a)+(((2-p)/p^2)-((1+2*a)/p)+a^2+a)*(u+v)^2)-(v*(1/p-a)+u*(1/p-a))^2+2*v^2);
